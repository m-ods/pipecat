...
from pipecat.transports.services.tavus import TavusCallbacks, TavusTransportClient
...
class TavusVideoService(AIService):
    ...
    async def setup(self, setup: FrameProcessorSetup):
        ...
        self._client = TavusTransportClient(
            ...
            params=DailyParams(
                # TODO (Filipi): we should to enable this if we are able to use the Microphone Echo mode
        ...
        while True:
            ...
            if done:
                ...
                while len(audio_buffer) >= MAX_CHUNK_SIZE:
                    ...
                    wait = start_time + (samples_sent / self._sample_rate) - time.time()
                    if wait > 0:
